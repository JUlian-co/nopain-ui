...
var GradientText = ({
  ...
  const gradient = via ? `linear-gradient(to right, ${from}, ${via}, ${to})` : `linear-gradient(to right, ${from}, ${to})`;
  ...
  return /* @__PURE__ */ import_react.default.createElement(Tag, { style: gradientStyle, className }, children, underline && /* @__PURE__ */ import_react.default.createElement(
    "span",
    {
      style: {
        display: "block",
